/* NOTE: Careful regenerating! `wordToTypeMap` in xclualex.h depends on the order of wordlist! */
/* C code produced by gperf version 3.0.1 */
/* Command-line: 'C:\\MinGW\\bin\\gperf.exe' ./data/keywords.gperf  */
/* Computed positions: -k'1,$' */
#ifndef XC_LUA_KEYWORDS_H
#define XC_LUA_KEYWORDS_H
#include <string.h>
